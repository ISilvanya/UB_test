...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("СписокДоступныхПоказателей") Тогда
		Отбор = Показатели.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		Отбор.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке;
		Отбор.ПравоеЗначение = Параметры.СписокДоступныхПоказателей;
		Отбор.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Идентификатор");
		Отбор.Использование = Истина;
	КонецЕсли;	
	
	Элементы.ГруппаФормула.ТолькоПросмотр = Параметры.ТолькоПросмотр;
	Элементы.ГруппаПоказатели.ТолькоПросмотр = Параметры.ТолькоПросмотр;
	Элементы.ФормаОК.Доступность = НЕ Параметры.ТолькоПросмотр;
КонецПроцедуры
