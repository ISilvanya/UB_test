...
Процедура УстановитьУсловноеОформление()
	...
	УБ_ОбщегоНазначения.ДобавитьУсловноеОформление(ЭтотОбъект, 
												   Новый Структура("ЦветТекста", WebЦвета.ГрифельноСерый), 
												   Новый Структура("ТЧ, Поле, Значение, ВидСравнения",
												   					"Список", 
												   					"АктуальныйДокумент", 
												   					Ложь, 
