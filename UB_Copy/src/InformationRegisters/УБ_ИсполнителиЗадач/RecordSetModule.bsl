...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если Количество() > 0 Тогда
		...
		ГруппыИсполнителейЗадач = УБ_БизнесПроцессыИЗадачиСервер.ГруппыИсполнителейЗадач(НовыеИсполнителиЗадач);
...
Процедура ЗаполнитьИзмененныеГруппыИсполнителейЗадач()
	...
	|	ИЗ
	|		(ВЫБРАТЬ
	|			УБ_ИсполнителиЗадач.РольИсполнителя КАК РольИсполнителя,
	|			УБ_ИсполнителиЗадач.Исполнитель КАК Исполнитель,
	|			УБ_ИсполнителиЗадач.ОсновнойОбъектАдресации КАК ОсновнойОбъектАдресации,
	|			УБ_ИсполнителиЗадач.ДополнительныйОбъектАдресации КАК ДополнительныйОбъектАдресации,
	|			УБ_ИсполнителиЗадач.ГруппаИсполнителейЗадач КАК ГруппаИсполнителейЗадач,
	...
	|ГДЕ
	|	Итог.ГруппаИсполнителейЗадач <> ЗНАЧЕНИЕ(Справочник.УБ_ГруппыИсполнителейЗадач.ПустаяСсылка)";
	
	УсловияОтбора = "Истина";
	Для каждого ЭлементОтбора Из Отбор Цикл
		Если ЭлементОтбора.Использование Тогда
			УсловияОтбора = УсловияОтбора + "
			|И УБ_ИсполнителиЗадач." + ЭлементОтбора.Имя + " = &" + ЭлементОтбора.Имя;
