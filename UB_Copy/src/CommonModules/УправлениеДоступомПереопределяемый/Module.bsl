...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	// Управление бизнесом 
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "УБ_Подразделения";
	//ВидДоступа.Имя = "Подразделение";
	ВидДоступа.Представление = НСтр("ru = 'Подразделения (УБ)'");
	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.УБ_Подразделения");
	
	//Если ПолучитьФункциональнуюОпцию("УБ_УправлениеТорговлей") Тогда
	//	ВидДоступа = ВидыДоступа.Добавить();
	//	ВидДоступа.Имя = "УБ_Сотрудники";
	//	ВидДоступа.Представление = НСтр("ru = 'Сотрудники (УБ)'");
	//	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.УБ_Сотрудники");
	//КонецЕсли;
	// Управление бизнесом
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	// Управление бизнесом 
	Списки.Вставить(Метаданные.Справочники.УБ_Подразделения, Истина);
	Списки.Вставить(Метаданные.Документы.УБ_РасчетЭффективностиСотрудников, Истина);
	Списки.Вставить(Метаданные.Документы.УБ_ПланированиеЦелейИПоказателей, Истина);
	Списки.Вставить(Метаданные.РегистрыСведений.УБ_ДанныеДляПодбораСотрудников, Истина);
	// Управление бизнесом 
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// Управление бизнесом 	
	УБ_УправлениеДоступом.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления);
	// Управление бизнесом
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	    // ШОО не надо по той причине, что подобное ограничение не используется сейчас
	// т.о., при внедрении можно пропустить, но в конфигурации разработки оставить
	//// Управление бизнесом //!!! проверить - надо? не надо?
//	Описание = Описание 
//		+ "
//		|Документ.УБ_РасчетЭффективностиСотрудников.Чтение.Пользователи
//		|Документ.УБ_РасчетЭффективностиСотрудников.Изменение.Пользователи
//		|Документ.УБ_ПланированиеЦелейИПоказателей.Чтение.Подразделения
//		|Документ.УБ_ПланированиеЦелейИПоказателей.Изменение.Подразделения";
//// Управление бизнесом 
