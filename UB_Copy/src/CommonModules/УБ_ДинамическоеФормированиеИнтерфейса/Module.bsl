...
// Создание типа "Таблица диаграмма"
Функция ОписаниеТипаДиаграмма() Экспорт
	
	МассивТипаВыбора = Новый Массив;
	МассивТипаВыбора.Добавить(Тип("Диаграмма"));
	Возврат Новый ОписаниеТипов(МассивТипаВыбора);	
...
#Область КопированиеЭлементов
&НаСервере
Функция СоздатьКопиюЭлемента(Форма, ЭлементИсточника, ПрефиксКопии, ГруппаЭлементов = Неопределено, УстанавливатьПутьКДанным = Истина) Экспорт
    
    Тип = ТипЗнч(ЭлементИсточника);
    
    ЭлементПриемника = Форма.Элементы.Добавить(ЭлементИсточника.Имя+ПрефиксКопии, Тип, ГруппаЭлементов);
    Если Тип = Тип("ГруппаФормы") Тогда
        ...
        СкопироватьПодчиненныеЭлементы(Форма, ЭлементПриемника, ЭлементИсточника, ПрефиксКопии, УстанавливатьПутьКДанным);
        
    ИначеЕсли Тип = Тип("ПолеФормы") Тогда
        
        ЭлементПриемника.Вид = ЭлементИсточника.Вид; 
		Если УстанавливатьПутьКДанным Тогда
			ЭлементПриемника.ПутьКДанным = ЭлементИсточника.ПутьКДанным + ПрефиксКопии;	        
		Иначе
    ...
    ИначеЕсли Тип = Тип("ТаблицаФормы") Тогда
        ...
        СкопироватьКнопкиКоманднойПанелиТаблицы(Форма, ЭлементПриемника.КоманднаяПанель, ЭлементИсточника.КоманднаяПанель, ПрефиксКопии);
    ...
    ИначеЕсли Тип = Тип("КнопкаФормы") Тогда
        ...
        СкопироватьКоманду(Форма, ЭлементПриемника, ЭлементИсточника, ПрефиксКопии);
...
&НаСервере
Процедура СкопироватьПодчиненныеЭлементы(Форма, Приемник, Источник, ПрефиксКопии, УстанавливатьПутьКДанным) Экспорт
    
    Для Каждого ЭлементИсточника Из Источник.ПодчиненныеЭлементы Цикл
        СоздатьКопиюЭлемента(Форма, ЭлементИсточника, ПрефиксКопии, Приемник, УстанавливатьПутьКДанным);
    КонецЦикла; 
...
&НаСервере
Процедура СкопироватьКнопкиКоманднойПанелиТаблицы(Форма, ГруппаКнопокПриемник, ГруппаКнопокИсточник,ПрефиксКопии) Экспорт
    ...
    Для Каждого ЭлементИсточника из ГруппаКнопокИсточник.ПодчиненныеЭлементы Цикл
        ...
        Если Найти(НРег(ЭлементИсточника.Имя), "кнопк") > 0 Тогда 
            ...
            Тип = ТипЗнч(ЭлементИсточника);
            ЭлементПриемника = Форма.Элементы.Добавить(ПрефиксКопии + ЭлементИсточника.Имя, Тип, ГруппаКнопокПриемник);
            ...
            Если Тип = Тип("ГруппаФормы") Тогда
                ...
                СкопироватьКнопкиКоманднойПанелиТаблицы(Форма, ЭлементПриемника, ЭлементИсточника, ПрефиксКопии);
...
&НаСервере
Процедура СкопироватьКоманду(Форма, ЭлементПриемник, ЭлементИсточник, ПрефиксКопии) Экспорт
    ...
    Если КомандаПриемник = Неопределено Тогда
        КомандаПриемник = Форма.Команды.Добавить(ПрефиксКопии + КомандаИсточник.Имя);
    КонецЕсли;     
