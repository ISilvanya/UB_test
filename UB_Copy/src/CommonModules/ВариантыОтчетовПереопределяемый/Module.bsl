...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	// +УБ
	УБ_ВариантыОтчетов.ОпределитьРазделыСВариантамиОтчетов(Разделы);
	// -УБ
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// +УБ
	УБ_ВариантыОтчетов.НастроитьВариантыОтчетов(Настройки);
	// -УБ
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	// +УБ
	УБ_ВариантыОтчетов.ОпределитьОбъектыСКомандамиОтчетов(Объекты);
	// -УБ
