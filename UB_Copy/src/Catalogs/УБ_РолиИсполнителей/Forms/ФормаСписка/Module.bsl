...
Процедура НастроитьОтображениеСпискаРолей()
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.УБ_РолиИсполнителей КАК СправочникРолиИсполнителей
	|		ПО УБ_ИсполнителиЗадач.РольИсполнителя = СправочникРолиИсполнителей.Ссылка
	|;";
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьВнешнихПользователей") Тогда
		...
		|ИЗ
		|	Справочник.УБ_РолиИсполнителей КАК СправочникРолиИсполнителей";
	...
	СвойстваСписка.ОсновнаяТаблица              = "Справочник.УБ_РолиИсполнителей";
